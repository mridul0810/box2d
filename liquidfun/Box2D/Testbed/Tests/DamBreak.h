...
pd.position.Set(43, 25+i*2);
			...
			//b2ParticleGroup * const group1 = m_particleSystem->CreateParticleGroup(pd);
			//b2ParticleGroup * const group2 = m_particleSystem->CreateParticleGroup(pd);
