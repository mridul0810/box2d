...
#include "dominos.hpp"
   ...
   */ 
   ...
   dominos_t::dominos_t()
   {
    ...
    //The tank pulley system closing door
    {
      ...
      b2Vec2 worldAnchorOnBody2(32, 25); // Anchor point on body 1 in world axis
      ...
      b2Vec2 worldAnchorGround1(32, 40); // Anchor point for ground 2 in world axis
 ...
 //    }
  ...
  //sphere with dominos
    ...
    b2BodyDef ballbd;
    ballbd.type = b2_dynamicBody;
    ballbd.position.Set(-10.5f, 7.5f);
    spherebody = m_world->CreateBody(&ballbd);
    spherebody->CreateFixture(&ballfd);
...
//
  ...
  //sphere with dominos
    ...
    b2BodyDef ballbd;
    ballbd.type = b2_dynamicBody;
    ballbd.position.Set(-42.5f, 7.5f);
    spherebody = m_world->CreateBody(&ballbd);
    spherebody->CreateFixture(&ballfd);*/
...
//
    ...
    //Dominos
  {
    ...
    for (int i = 0; i < 9; ++i)
    {
      b2BodyDef bd;
      bd.type = b2_dynamicBody;
      bd.position.Set(-42.5f + 1.0f * i, 17.3f);
      b2Body* body = m_world->CreateBody(&bd);
      body->CreateFixture(&fd);
...
//ball on rotating platform
    ...
    b2BodyDef ballbd;
    ballbd.type = b2_dynamicBody;
    ballbd.position.Set(-29.6f, 17.0f);
    spherebody = m_world->CreateBody(&ballbd);
    spherebody->CreateFixture(&ballfd);
    b2BodyDef ballbd1;
    ballbd1.type = b2_dynamicBody;
    ballbd1.position.Set(-27.4f, 17.0f);
...
// Balloon part
  {
    ...
    { 
      ...
      b2DistanceJoint* joint = (b2DistanceJoint*)m_world->CreateJoint( &jointDef[i] );
    }
